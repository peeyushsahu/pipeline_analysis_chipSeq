...
class count_overlap_from_bed(object):
	...
	def overlap_wid_allEncode(self):
...
if __name__ == '__main__':
	...
	for i in range(length_meta):
		#print(start, stop)
		task.put(count_overlap_from_bed(peak_df, meta_df_bed[start:stop], start))
		start = stop
	...
	out_df = out_df[['chr', 'start', 'stop']+list(set(out_df.columns)-set(['chr', 'start', 'stop']))]
